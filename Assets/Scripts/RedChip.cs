...
public class RedChip : MonoBehaviour
{
    //scoreboard
    ...
    void Update()
    {
        ...
        {
            okToEatUR = true;
            MGManager.disableRedMoveOthers();
    ...
    {
        if (redTurn == true && disabled == false)
        {
            onHighlight = !onHighlight;
            picked = !picked;
            MGManager.rSwitchPicked.Add(this);
    ...
    public void removeMeToR()
    {
        MGManager.r.Remove(this);
    }
